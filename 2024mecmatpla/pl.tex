...
\begin{center}
\input{_reconnection_diffusions}
\end{center}
...
% $\to$ the advection of $B$ at the velocity $U$ results from the frozen-in condition in the plasma, far above the CS where MHD is ideal \\
